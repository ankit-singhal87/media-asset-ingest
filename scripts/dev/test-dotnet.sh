...
test_projects="tests/MediaIngest.Foundation.Tests/MediaIngest.Foundation.Tests.csproj tests/MediaIngest.Contracts.Tests/MediaIngest.Contracts.Tests.csproj tests/MediaIngest.Worker.Watcher.Tests/MediaIngest.Worker.Watcher.Tests.csproj tests/MediaIngest.Persistence.Tests/MediaIngest.Persistence.Tests.csproj tests/MediaIngest.Worker.Outbox.Tests/MediaIngest.Worker.Outbox.Tests.csproj tests/MediaIngest.Workflow.Tests/MediaIngest.Workflow.Tests.csproj"
