...
| GitHub tracker change | `make github-project-summary` and `make github-project-hierarchy` | `make github-project-active`, `make github-projects-script-test`, plus targeted `gh issue view` or dependency checks | no | no | cheap |
