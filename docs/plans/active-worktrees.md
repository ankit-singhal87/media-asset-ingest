...
| `.worktrees/parallel-06-courier-outbox-shape` | `USER-STORY-8-courier-outbox-shape` | none | USER-STORY-8 | Courier | `src/MediaIngest.Worker.Outbox`, `tests/MediaIngest.Worker.Outbox.Tests`, `docs/plans/active-worktrees.md`, `docs/status/work-log.md` | Ready For PR | none |
