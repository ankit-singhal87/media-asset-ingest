...
| `.worktrees/TASK-8-1-react-control-plane` | `TASK-8-1-react-control-plane` | #33 | USER-STORY-12 | Canvas | `web/ingest-control-plane`, `docs/plans/task-index.md`, `docs/plans/active-worktrees.md`, `docs/status/work-log.md`, `docs/standards/typescript-react.md` | Ready For PR | none |
