...
| `.worktrees/USER-STORY-2-local-manifest-ingest-backend` | `USER-STORY-2-local-manifest-ingest-backend` | #12 | USER-STORY-2 | Mount | `.gitignore`, `MediaIngest.sln`, `src/MediaIngest.Api`, `src/MediaIngest.Persistence`, `src/MediaIngest.Worker.Watcher`, `tests/MediaIngest.Api.Tests`, `tests/MediaIngest.Worker.Watcher.Tests`, `Makefile`, `package.json`, `scripts/dev/test-dotnet.sh`, `docs/architecture`, `docs/product`, `docs/status/work-log.md` | Cleaned Up | https://github.com/ankit-singhal87/media-asset-ingest/pull/45 |
...
| `.worktrees/parallel-02-vault-postgresql-persistence` | `USER-STORY-8-vault-postgresql-persistence` | #18 | USER-STORY-8 | Vault | `src/MediaIngest.Persistence`, `tests/MediaIngest.Persistence.Tests`, `docs/plans/active-worktrees.md` | Cleaned Up | https://github.com/ankit-singhal87/media-asset-ingest/pull/56 |
| `.worktrees/parallel-06-courier-outbox-shape` | `USER-STORY-8-courier-outbox-shape` | none | USER-STORY-8 | Courier | `src/MediaIngest.Worker.Outbox`, `tests/MediaIngest.Worker.Outbox.Tests`, `docs/plans/active-worktrees.md`, `docs/status/work-log.md` | Cleaned Up | https://github.com/ankit-singhal87/media-asset-ingest/pull/55 |
| `.worktrees/parallel-07-pulse-workflow-boundary` | `USER-STORY-9-pulse-workflow-boundary` | none | USER-STORY-9 | Pulse | `src/MediaIngest.Workflow`, `tests/MediaIngest.Workflow.Tests` | Cleaned Up | https://github.com/ankit-singhal87/media-asset-ingest/pull/54 |
| `.worktrees/parallel-09-gauge-e2e-smoke` | `parallel-09-gauge-e2e-smoke` | none | none | Gauge | `scripts/dev/local-e2e-smoke.sh`, `docs/automation/local-smoke-tests.md`, `docs/automation/commands.md`, `docs/automation/validation.md`, `docs/automation/README.md`, `docs/plans/active-worktrees.md` | Cleaned Up | https://github.com/ankit-singhal87/media-asset-ingest/pull/53 |
| `.worktrees/parallel-03-canvas-local-status-ui` | `USER-STORY-12-canvas-local-status-ui` | #22 | USER-STORY-12 | Canvas | `web/ingest-control-plane`, `docs/plans/active-worktrees.md` | Cleaned Up | https://github.com/ankit-singhal87/media-asset-ingest/pull/52 |
| `.worktrees/parallel-04-mount-file-discovery` | `USER-STORY-3-mount-file-discovery` | #13 | USER-STORY-3 | Mount | `src/MediaIngest.Worker.Watcher`, `tests/MediaIngest.Worker.Watcher.Tests`, `docs/plans/active-worktrees.md`, `docs/status/work-log.md` | Cleaned Up | https://github.com/ankit-singhal87/media-asset-ingest/pull/51 |
| `.worktrees/parallel-08-beacon-runtime-diagnostics` | `parallel-08-beacon-runtime-diagnostics` | Track 08 | USER-STORY-11 | Beacon | `src/MediaIngest.Observability`, `tests/MediaIngest.Observability.Tests`, `docs/plans/active-worktrees.md`, `docs/status/work-log.md` | Cleaned Up | https://github.com/ankit-singhal87/media-asset-ingest/pull/50 |
| `.worktrees/parallel-05-essence-checksum-validator` | `parallel-05-essence-checksum-validator` | none | USER-STORY-7 | Essence | `src/MediaIngest.Essence`, `tests/MediaIngest.Essence.Tests`, `docs/plans/active-worktrees.md`, `docs/status/work-log.md` | Cleaned Up | https://github.com/ankit-singhal87/media-asset-ingest/pull/49 |
| `.worktrees/parallel-01-forge-docker-runtime` | `parallel-01-forge-docker-runtime` | none | USER-STORY-16 | Forge | `deploy/docker`, `docs/plans/active-worktrees.md` | Cleaned Up | https://github.com/ankit-singhal87/media-asset-ingest/pull/47 |
