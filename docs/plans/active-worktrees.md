...
| `.worktrees/parallel-03-canvas-local-status-ui` | `USER-STORY-12-canvas-local-status-ui` | #22 | USER-STORY-12 | Canvas | `web/ingest-control-plane`, `docs/plans/active-worktrees.md` | Ready For PR | not-created |
