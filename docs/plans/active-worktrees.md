...
| `.worktrees/parallel-07-pulse-workflow-boundary` | `USER-STORY-9-pulse-workflow-boundary` | none | USER-STORY-9 | Pulse | `src/MediaIngest.Workflow`, `tests/MediaIngest.Workflow.Tests` | Ready For PR | none |
